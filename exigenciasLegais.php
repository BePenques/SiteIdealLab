...
<html>
	...
	<body>
		<div id="site">
			...
			<section id="sobrenos">	
				...
				<div id="div_scroll">	
					...
					<?php 
		if($pagina_atual > 1){ ?>
			<a class="tirar_sublinhado" href="exigenciasLegais.php?pagina_atual=<?php echo ($pagina_atual - 1)?>">&#9668</a>
		<?php }
		...
		if($pagina_atual != $qtde_paginas){ ?>
			<a class="tirar_sublinhado" href="exigenciasLegais.php?pagina_atual=<?php echo ($pagina_atual + 1)?>">&#9658</a>
		<?php } ?>
